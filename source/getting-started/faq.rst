...
Two methods exist to submit an appliance to the *Appliance Catalog*. They can be added using the simplified process_ available through the *Images* view. They can also be added using the manual process as described below:
