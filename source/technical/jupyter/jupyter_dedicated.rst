...
:ref:`Trovi <trovi>` provides a `JupyterHub appliance <https://trovi.chameleoncloud.org/dashboard/artifacts/6a30d3fb-8c8a-49b1-a415-cd9c7fc0a6e3>_` you can instantiate on
Chameleon. Filter Trovi artifacts by the **appliance** tag to find it. The
appliance will allow you to reserve a Chameleon bare metal node and provision
it with the JupyterHub application, along with a
...
shared default Chameleon JupyterHub*; it's `JupyterHub all the way down <https://en.wikipedia.org/wiki/Turtles_all_the_way_down>`_!
